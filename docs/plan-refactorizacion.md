...
1. **La landing estática depende de 3 descargas CDN + transpilación en el navegador.**
   `support.js` (runtime propietario "DC", 1581 líneas, generado y marcado *"do not edit"*) carga en tiempo de ejecución desde unpkg:
...
Fase 0 → **Fase 1** (desbloquea el 80% del valor) → Fase 2 → Fase 3 → Fase 4.
Las fases 0 y 1 ya justifican el trabajo por sí solas; 2–4 elevan la mantenibilidad a medio plazo.
